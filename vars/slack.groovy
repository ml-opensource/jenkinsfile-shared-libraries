...
def getTestSummary() {
	...
	total = testResultAction.getTotalCount()
        ...
        println "ENV1 ${env.SLACK_TEST_TOTAL}"
        println "Total1 ${total}"
        println "OrgTotal1 ${orgtotal}"
