 ...
 * @see gradlew#setup
 */
def setup(String nodeVersion = 'node', boolean useClosure = false, Closure body = null) {
	if (useClosure) {
		stage("Configure Environment") {
			setupNoStage(nodeVersion, body)	
		}
	} else {
		setupNoStage(nodeVersion, body)	
	}
...
def setupNoStage(String nodeVersion = 'node', Closure body = null) {
